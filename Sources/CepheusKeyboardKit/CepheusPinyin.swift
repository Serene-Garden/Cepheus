...
func groupedPinyin(input: String) -> [String] {
  ...
  for composerCursor in 0..<letters.count { //Check the syllables
    if !shouldLetterBeSkipped[composerCursor] { //The letter should be skipped if it's not the first letter in a syllable.
      ...
      case "g":
        syllable = "g" + connectVowels(letters, cursor: composerCursor, allowments: ["a": true, "ai": true, "an": true, "ang": true, "ao": true, "e": true, "ei": true, "en": true, "eng": true, "ong": true, "ou": true, "u": true, "ua": true, "uai": true, "uan": true, "uang": true])
      case "h":
